...
class Conf:
    ...
    fields = ['open', 'close', 'high', 'low', 'volume', 'price_2avg']
    shift = -1
    # model conf
    batch_size = 500
    epochs = 20
...
if __name__ == '__main__':
    ...
    y_train = forex_dataset.y_dataset(ds, Conf.seq_len, Conf.shift, logfile)
    # 测试数据
    ds_test = forex_dataset.load_data(Conf.filename_test, Conf.fields)
    ...
    y_test = forex_dataset.y_dataset(ds_test, Conf.seq_len, Conf.shift, logfile)
